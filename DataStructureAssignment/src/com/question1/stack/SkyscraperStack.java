package com.question1.stack;

import java.util.Arrays;
import java.util.Stack;

public class SkyscraperStack {
	static boolean largestNumber;
	static boolean addFlag;

	// Push the floor sizes in stack using following function module.
	...
	public static void calculateFloors(int[] floorSize) {
		...
		for (int i = 0; i < floorSize.length; i++) {
			...
			// Make a clone of array of floor sizes stored in stack.
